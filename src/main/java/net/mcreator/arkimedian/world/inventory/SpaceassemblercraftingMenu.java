...
public class SpaceassemblercraftingMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public SpaceassemblercraftingMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ArkimedianModMenus.SPACEASSEMBLERCRAFTING.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 16, 17) {
			...
			private int x = SpaceassemblercraftingMenu.this.x;
			private int y = SpaceassemblercraftingMenu.this.y;
		}));
