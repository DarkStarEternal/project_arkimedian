package net.mcreator.arkimedian.world.features;
...
import net.mcreator.arkimedian.world.features.configurations.StructureFeatureConfiguration;
...
public class StructureFeature extends Feature<StructureFeatureConfiguration> {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.FEATURES, ArkimedianMod.MODID);
