...
public class RespawnonsalvaesignorisProcedure {
	@SubscribeEvent
		...
		if (world.getDifficulty() == Difficulty.HARD) {
			if ((entity.level().dimension()) == Level.OVERWORLD) {
				...
				if (entity instanceof ServerPlayer _player && !_player.level().isClientSide()) {
					ResourceKey<Level> destinationType = ResourceKey.create(Registries.DIMENSION, new ResourceLocation("arkimedian:salvae_signoris"));
