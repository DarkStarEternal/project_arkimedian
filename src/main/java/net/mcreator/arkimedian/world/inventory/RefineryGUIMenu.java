...
public class RefineryGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public RefineryGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ArkimedianModMenus.REFINERY_GUI.get(), id);
