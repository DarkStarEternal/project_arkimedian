...
public class STORAGEGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public STORAGEGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ArkimedianModMenus.STORAGEGUI.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 7, 8) {
			...
			private int x = STORAGEGUIMenu.this.x;
			private int y = STORAGEGUIMenu.this.y;
		}));
