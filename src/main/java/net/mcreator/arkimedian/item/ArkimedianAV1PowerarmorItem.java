...
public abstract class ArkimedianAV1PowerarmorItem extends ArmorItem {
	public ArkimedianAV1PowerarmorItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			@Override
			public int getDurabilityForType(ArmorItem.Type type) {
				return new int[]{13, 15, 16, 11}[type.getSlot().getIndex()] * 101;
			}
			...
			public String getName() {
				return "arkimedian_av_1_powerarmor";
			}
	...
	public static class Helmet extends ArkimedianAV1PowerarmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "arkimedian:textures/entities/suit.png";
		}
	}

	public static class Chestplate extends ArkimedianAV1PowerarmorItem {
		public Chestplate() {
	...
	public static class Leggings extends ArkimedianAV1PowerarmorItem {
		public Leggings() {
	...
	public static class Boots extends ArkimedianAV1PowerarmorItem {
		public Boots() {
